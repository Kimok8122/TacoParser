...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var iLocations = lines.Select(parser.Parse).ToArray();
            ...
            for (int i = 0; i < iLocations.Length; i++)

            {
                var locA = iLocations[i];
                ...
                for (int k = 0; k < iLocations.Length; k++)
                {
                    var locB = iLocations[k];
